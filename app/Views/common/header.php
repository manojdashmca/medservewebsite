                            ...
                            <div class="rd-navbar-aside">
                                ...
                                <div class="rd-navbar-aside-box rd-navbar-collapse">
                                    ...
                                    <ul class="rd-navbar-aside-nav">
                                        ...
                                        <li><a href="<?= base_url() ?>/shipping-delivery">Shipping</a></li>
                                        <li><a href="<?= base_url() ?>/carrier">Carrier</a></li>
                            ...
                            <div class="rd-navbar-main">
                                ...
                                <div class="rd-navbar-panel">
                                    ...
                                    <ul class="rd-navbar-nav-acc">
                                        <li>
                                            <button class="icon fa-cloud-upload" data-toggle="modal" data-target="#modal-upload" title="Upload Prescription"></button>
                                        </li>
                                        <li>
